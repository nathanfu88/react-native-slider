...
this.props,minimumValue=_props.minimumValue,maximumValue=_props.maximumValue,minimumTrackTintColor=_props.minimumTrackTintColor,maximumTrackTintColor=_props.maximumTrackTintColor,thumbTintColor=_props.thumbTintColor,thumbImage=_props.thumbImage,styles=_props.styles,style=_props.style,trackStyle=_props.trackStyle,trackOffset=_props.trackOffset,minTrackStyle=_props.minTrackStyle,thumbComponent=_props.thumbComponent,thumbStyle=_props.thumbStyle,debugTouchArea=_props.debugTouchArea,onValueChange=_props.onValueChange,thumbTouchSize=_props.thumbTouchSize,animationType=_props.animationType,animateTransitions=_props.animateTransitions,graduations=_props.graduations,graduationStyle=_props.graduationStyle,other=_objectWithoutProperties(_props,['minimumValue','maximumValue','minimumTrackTintColor','maximumTrackTintColor','thumbTintColor','thumbImage','styles','style','trackStyle','trackOffset','minTrackStyle','thumbComponent','thumbStyle','debugTouchArea','onValueChange','thumbTouchSize','animationType','animateTransitions','graduations','graduationStyle']);var _state=
...
this.state,value=_state.value,containerSize=_state.containerSize,thumbSize=_state.thumbSize,graduationSize=_state.graduationSize,allMeasured=_state.allMeasured;
var mainStyles=styles||defaultStyles;
var thumbWidthHalf=thumbSize.width/2;
var thumbLeftMinOutput=MIN_GRADUATION_MARGIN;
var thumbLeftMaxOutput=containerSize.width-thumbSize.width-MIN_GRADUATION_MARGIN;
...
var minimumTrackWidth=minimumValue===maximumValue&&this.props.value===minimumValue?
...
var minTrackWidth=this.props.value===minimumValue?
minimumTrackWidth:
_reactNative.Animated.add(minimumTrackWidth,thumbWidthHalf-trackOffset);

if(thumbStyle.backgroundColor==="transparent"&&thumbStyle.width===0){

var gradOffset=this._getGraduationOffset(this.props.value);
...
onLayout:this._measureContainer,__source:{fileName:_jsxFileName,lineNumber:331}}),
...
renderToHardwareTextureAndroid:true,
style:[mainStyles.track,trackStyle,minimumTrackStyle,minTrackStyle],__source:{fileName:_jsxFileName,lineNumber:346}}),
...
valueVisibleStyle)],__source:{fileName:_jsxFileName,lineNumber:351}},
...
this._panResponder.panHandlers,{__source:{fileName:_jsxFileName,lineNumber:368}}),
...
_this2.props,graduations=_props2.graduations,trackOffset=_props2.trackOffset;var _state2=
...
_renderDebugThumbTouchRect=function(){
return(
_react2.default.createElement(_reactNative.View,{
style:[defaultStyles.debugThumbTouchArea],
pointerEvents:'none',__source:{fileName:_jsxFileName,lineNumber:608}}));


};this.

_renderThumbText=function(){var _props3=
_this2.props,thumbText=_props3.thumbText,thumbTextStyle=_props3.thumbTextStyle;

if(!thumbText)return;
return(
_react2.default.createElement(_reactNative.Text,{style:[defaultStyles.thumbText,thumbTextStyle],__source:{fileName:_jsxFileName,lineNumber:620}},thumbText));
...
return _react2.default.createElement(_reactNative.Image,{source:thumbImage,__source:{fileName:_jsxFileName,lineNumber:629}});
};this.

_renderGraduations=function(mainStyles,valueVisibleStyle){var _props4=
_this2.props,graduations=_props4.graduations,maximumTrackTintColor=_props4.maximumTrackTintColor,graduationStyle=_props4.graduationStyle;var _state3=
...
left:_this2._getGraduationOffset(i)},valueVisibleStyle)],__source:{fileName:_jsxFileName,lineNumber:640}}));}));
