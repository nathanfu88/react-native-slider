...
onLayout:this._measureContainer,__source:{fileName:_jsxFileName,lineNumber:316}}),
...
onLayout:this._measureTrack,__source:{fileName:_jsxFileName,lineNumber:321}}),
...
pointerEvents:'none',__source:{fileName:_jsxFileName,lineNumber:627}}));
...
if(!thumbText)return;
return(
_react2.default.createElement(_reactNative.Text,{style:[defaultStyles.thumbText,thumbTextStyle],__source:{fileName:_jsxFileName,lineNumber:639}},thumbText));
...
left:_this2._getGraduationOffset(i)},valueVisibleStyle)],__source:{fileName:_jsxFileName,lineNumber:659}}));}));
