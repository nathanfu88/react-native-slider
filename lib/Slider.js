...
this.state,value=_state.value,containerSize=_state.containerSize,trackSize=_state.trackSize,thumbSize=_state.thumbSize,graduationSize=_state.graduationSize,allMeasured=_state.allMeasured;
...
renderToHardwareTextureAndroid:true,
style:[mainStyles.track,trackStyle,minimumTrackStyle,minTrackStyle],__source:{fileName:_jsxFileName,lineNumber:329}}),
...
valueVisibleStyle)],__source:{fileName:_jsxFileName,lineNumber:334}},
...
this._panResponder.panHandlers,{__source:{fileName:_jsxFileName,lineNumber:351}}),
...
_this2.state,graduationSize=_state2.graduationSize,thumbSize=_state2.thumbSize,trackSize=_state2.trackSize;
...
pointerEvents:'none',__source:{fileName:_jsxFileName,lineNumber:616}}));
...
if(!thumbText)return;
return(
_react2.default.createElement(_reactNative.Text,{style:[defaultStyles.thumbText,thumbTextStyle],__source:{fileName:_jsxFileName,lineNumber:628}},thumbText));
...
return _react2.default.createElement(_reactNative.Image,{source:thumbImage,__source:{fileName:_jsxFileName,lineNumber:637}});
};this.
...
left:_this2._getGraduationOffset(i)},valueVisibleStyle)],__source:{fileName:_jsxFileName,lineNumber:648}}));}));
